...
class CRM_Contribute_Page_Tab extends CRM_Core_Page {
  ...
  function &recurLinks($recurID = FALSE, $context = 'contribution') {
    ...
    if ($recurID) {
      ...
      if ($paymentProcessorObj && $paymentProcessorObj->isSupported('cancelSubscription')) {
      ...
      if ($paymentProcessorObj && $paymentProcessorObj->isSupported('updateSubscriptionBillingInfo')) {
