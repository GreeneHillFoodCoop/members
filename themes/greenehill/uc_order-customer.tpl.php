      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" bgcolor="#FFFFFF" style="font-family: verdana, arial, helvetica; font-size: small;">
        ...
        <tr valign="top">
          <td>
            ...
            <?php echo t('Below is your current invoice. Please be aware that you may not receive all of the items you ordered since we order from distributors in bulk. You will receive an updated invoice closer to pickup day.'); ?>
            </p>
            <?php } ?>
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                      ...
                      <td colspan="2">
                        ...
                        <table width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                          ...
                          <tr>
                            ...
                            <td valign="top" nowrap="nowrap">
                              <b><?php echo $node->field_unit[0]['value']; ?> </b>
                            </td>
                            <td width="98%">
              ...
              <tr>
                <td colspan="2">
                  ...
                  <?php echo t('To view your orders log in at !store_link.', array('!store_link' => $store_link,)); ?>
                  <br /></p>
                  <?php } ?>
                  ...
                  <p><?php echo t('Thanks for taking part in the buying club.'); ?></p>
                  <?php } ?>

                  <?php if ($store_footer) { ?>
                  <p><b><?php echo $store_link; ?></b></p>
                  <?php } ?>
                </td>
              </tr>
              <?php } ?>
